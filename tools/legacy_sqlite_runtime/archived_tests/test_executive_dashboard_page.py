...
from tools.legacy_sqlite_runtime.executive_dashboard import ExecutiveDashboardService
...
class ExecutiveDashboardUiService:
    ...
    def executive_dashboard_report(self, filters=None):
        return ExecutiveDashboardService(self.conn).gerar_dashboard_executivo(filters)
...
class ExecutiveDashboardPageTests(unittest.TestCase):
    ...
    def test_interface_text_does_not_show_financial_terms(self):
        ...
        for forbidden in ("valor", "preco", "pre̤o", "subtotal", "imposto", "pagamento", "frete", "currency", "r$"):
